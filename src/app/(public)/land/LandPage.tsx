  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <Breadcrumb items={[{ label: "หน้าแรก", href: "/" }, { label: "ที่ดิน" }]} />
      </div>
      ...
      {/* Emotional Hook */}
      <EmotionalHook quote={LAND_CONTENT.hook.quote} message={LAND_CONTENT.hook.message} />
        ...
        <main className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {properties.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3 py-20 text-center">
              <p className="text-foreground text-lg font-medium">ยังไม่มีที่ดินในระบบ</p>
