...
import { updateRequestNotes } from "@/actions/requests"
import type { ServiceRequestType } from "@/lib/types/service-request"
...
export function RequestNotesEditor({ type, id, initialNotes }: RequestNotesEditorProps) {
  ...
  function saveNotes() {
    startTransition(async () => {
      await updateRequestNotes(type, id, notes)
      setSavedNotes(notes)
    })
  }
