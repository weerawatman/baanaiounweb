...
export default function HeroSection({ heroImage, districts }: HeroSectionProps) {
  ...
  return (
    <section className="relative isolate overflow-hidden py-11 text-center text-white sm:py-12 lg:py-14">
      <Image
        src={background}
      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <p className="mt-2 text-lg font-medium text-secondary [text-shadow:0_1px_2px_rgba(0,0,0,0.4)] sm:text-xl">
          {HERO.subTh}
        </p>
