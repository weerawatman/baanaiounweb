...
export const profileSchema = z.object({
  ...
  about_timeline_2002_image: z.string().default(""),
  about_timeline_2016_image: z.string().default(""),
  about_timeline_2020_image: z.string().default(""),
  about_timeline_2026_image: z.string().default(""),
