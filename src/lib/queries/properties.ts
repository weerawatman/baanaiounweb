...
const CARD_FIELDS =
  "id, slug, title, title_en, type, sub_type, price, price_label, price_label_en, status, featured, tags, images, image_primary, bedrooms, bathrooms, area_sqm, district, subdistrict, created_at"
