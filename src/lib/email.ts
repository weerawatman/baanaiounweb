...
function getEmailSubject(formTag: string): string {
  const subjects: Record<string, string> = {
    ...
    "co-agent": "[Co-Agent ใหม่] มีนายหน้าส่งทรัพย์มาเสนอร่วมปิดดีล | [New Co-Agent] Property partnership proposal from Baan Ai Oun Website",
    "academy": "[นักเรียนใหม่] สมัครคอร์สนายหน้า Workshop พลิกชีวิต | [New Student] Agent Course Registration from Baan Ai Oun Website",
    "contact": "[ติดต่อใหม่] ข้อความจากหน้าติดต่อเรา | [New Contact] Message from Baan Ai Oun Contact Page",
